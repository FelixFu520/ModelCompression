...
int main(int argc, char** argv){
    string src = "/root/data/fufa/modelcompression/quantization/checkpoints/wafer-qat-calibrated.onnx";
    string dst = "/root/data/fufa/modelcompression/quantization/checkpoints/wafer-qat-calibrated-int8.trt";
