...
quant_modules.initialize()
model = unet(nclass=2)
model.load_state_dict(torch.load("checkpoints/wafer-qat/qat_epoch_39_loss_0.143339_ce_0.132922_dice_0.010417.pth", map_location="cpu"))


def run():
    # imgPath = "./images/0000_Row006_Col036_00137_14.bmp"
    # dst = "./images/0000_Row006_Col036_00137_14-pth-qat.png"
    imgPath = "./images/0500_Row023_Col050_00953_21.bmp"
    dst = "./images/0500_Row023_Col050_00953_21-pth-qat.png"
