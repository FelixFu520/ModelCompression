...
__all__ = ['cross_entropy2d', 'bootstrapped_cross_entropy2d', 'DiceLoss', 'CriterionAll']
...
def bootstrapped_cross_entropy2d(input, target, K=10000, weight=None, size_average=True):
    ...
    def _bootstrap_xentropy_single(input, target, K, weight=None, size_average=True):
        ...
        #print("loss:",loss.shape) #torch.Size([65536])
...
class DiceLoss(nn.Module):
    ...
    def make_one_hot(labels, classes):
        ...
        #print("labels:",labels.shape) #torch.Size([64, 1, 256, 256])
